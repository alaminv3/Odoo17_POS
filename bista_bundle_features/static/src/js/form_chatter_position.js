...
//import {MailFormCompiler} from "@mail/views/web/form/form_compiler";
...
patch(FormCompiler.prototype, "web_chatter_position1", {
    /**
...
//            chatterContainerHookXml.setAttribute("t-if", true);
            ...
            if (webClientViewAttachmentViewHookXml) {
                ...
                const sheetBgChatterContainerXml =
                    sheetBgChatterContainerHookXml.querySelector("t[t-component='__comp__.mailComponents.Chatter']");
